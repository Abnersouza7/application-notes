...
interrupt pin connected, triggering one by tapping the board, running two vendors' sensors on one
bus, and establishing which of the features above each target actually implements.
