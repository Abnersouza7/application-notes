/*
 * AN0001 verification images for the NUCLEO-H503RB.
 *
 ...
 *
 *   make            -> build/an0001_image_a.bin  and  build/an0001_image_b.bin
 *
...
static void banner(uint32_t hz)
{
    uart_puts("\n");
    uart_puts("========================================\n");
    uart_puts("  Binho  |  AN0001\n");
    uart_puts("  Programming STM32 microcontrollers\n");
    uart_puts("  over I3C with the Binho Supernova\n");
    uart_puts("========================================\n");
