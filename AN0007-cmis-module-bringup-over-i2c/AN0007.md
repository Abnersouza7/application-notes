...
> **Draft, revision 0.2.** Every command in Section 5 has been run, and every output shown
...
![The 256 byte window a host addresses, and the pages behind it. The page select registers live in Lower Memory, so they stay reachable whichever page is selected.](figures/an0007-fig1-memory-map.svg)
