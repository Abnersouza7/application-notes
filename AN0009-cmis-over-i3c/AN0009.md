...
**Offline.** The register access layer this note drives is the one AN0008 self-checks, 8 of
8 against a simulated module. That covers the address arithmetic, not the I3C transport.
